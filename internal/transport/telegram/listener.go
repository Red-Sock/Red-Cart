...
func NewServer(_ config.Config, bot go_tg.TgApi, srv service.Storage) (s *Server) {
	s = &Server{
		bot: bot,
	}

	{
		...
		s.bot.SetDefaultCommandHandler(default_handler.NewDefaultCommandHandler(srv.User(), srv.Cart(), srv.Item()))
